<template>
	<div class="box">
		<div class="has-text-centered section">
			<p class="title has-text-centered">{{articleData.title}}</p>	
		...
		<div class="level">
			...
			<dropdown >
				<i slot="button-content" class="fa fa-cog "></i>
				<template v-if="articleData.authorized">
					<a :href="articleData.urls.delete" class="dropdown-item"><i class="fa fa-times"></i> Delete</a>
					<a :href="articleData.urls.edit" class="dropdown-item"><i class="fa fa-pencil"></i> Edit</a>
					<span class="dropdown-divider"></span>
				</template>
				<a href="#" class="dropdown-item"> <i class="fa fa-flag"></i> Report</a>
			</dropdown>
		</div></div></div>
		...
		<vote-controle @click="vote" :score="articleData.votes_info.score" :state="articleData.votes_info.state">
		</vote-controle>
