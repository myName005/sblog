...
var app = new Vue({
	...
	components: {
		...
		'bulma-field': __webpack_require__(41)
	}
});
...
var update = __webpack_require__(37)("5ffad9d1", content, false);
...
module.exports = {
	props: ['label', 'hasError', 'inputValue', 'inputType', 'inputName'],
	computed: {
